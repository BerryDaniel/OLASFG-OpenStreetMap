...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xmlns:ogc="http://www.opengis.net/ogc" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" version="1.0.0">
  <NamedLayer>
    <Name>road_trunk</Name>
    <UserStyle>
  <!-- start of trunk casing -->
  <FeatureTypeStyle>
        <Rule>
  ...
  <!-- end of trunk casing -->
    ...
    <FeatureTypeStyle>
        ...
        <Rule>
          ...
          <LineSymbolizer>
            <Stroke>
              <CssParameter name="stroke">#faafbb</CssParameter>
        ...
        <Rule>
          ...
          <LineSymbolizer>
            <Stroke>
              <CssParameter name="stroke">#e2a9a9</CssParameter>
              <CssParameter name="stroke-width">1</CssParameter>
              <CssParameter name="stroke-linejoin">round</CssParameter>
        <CssParameter name="stroke-linecap">round</CssParameter>
            </Stroke>
      ...
      <FeatureTypeStyle>
        <Rule>
          ...
          <TextSymbolizer>
            ...
            <Graphic>
              <ExternalGraphic>
                <OnlineResource xlink:href="trunk_ref.png" xlink:type="simple"/>
